    ...
    <div class="container text-center">
    	...
    	<form action="AgregarActMejora" method="post">
    		<div class="input-group mb-3">
			  ...
			  <input type="text" name="idMejora" class="form-control" aria-label="id actividad" >
			</div>
			<br />
	    	<div class="input-group mb-3">
			  <div class="input-group-prepend">
			...
			<br /><br />
			<a href="${pageContext.request.contextPath}/index"><button type="button" class="btn btn-primary btn-lg">volver al inicio</button></a>
			&nbsp&nbsp&nbsp&nbsp<button type="submit" class="btn btn-primary btn-lg">Crear</button>
